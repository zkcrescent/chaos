...
func init() {
	var t TableA
	if t.Sharding() > 0 {
		gorpUtil.Tables.Add(t.ShardInit(0 + 1))
	} else {
...
var (
	TableA_Field = gorpUtil.ShardTableField("table_a", "field", 1)
	TableA_ID    = gorpUtil.ShardTableField("table_a", "id", 1)
)
...
func (t TableA) Field_Field() *gorpUtil.Field {
	return TableA_Field(t.Shard())
}

func (t TableA) Field_ID() *gorpUtil.Field {
	return TableA_ID(t.Shard())
}

func (t *TableA) SetShard(shard int64) *TableA {
	t.ID = shard
	return t
}
...
func (t TableA) TableName() string {
	...
	return fmt.Sprintf("table_a_%v", t.Shard())
}

func (t TableA) BasicTableName() string {
	return "table_a"
}
